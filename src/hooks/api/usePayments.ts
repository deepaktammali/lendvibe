...
import { paymentService, paymentKeys, type CreatePaymentData, type UpdatePaymentData } from '@/services/api/payments.service';
...
export function useUpdatePayment() {
  ...
  return useMutation({
    mutationFn: ({ id, data, originalPayment }: { id: string; data: UpdatePaymentData; originalPayment: Payment }) =>
    ...
    onSuccess: (_, { id, data, originalPayment }) => {
      ...
      queryClient.setQueryData<Payment[]>(paymentKeys.byLoan(originalPayment.loan_id), updatePaymentInCache);

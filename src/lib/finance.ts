...
export function calculateAccruedInterest(
  loan: Pick<Loan, 'current_balance' | 'interest_rate' | 'repayment_interval_unit' | 'repayment_interval_value'>
): number {
 ...
 */
export function getNextPaymentDate(loan: Pick<Loan, 'start_date' | 'repayment_interval_unit' | 'repayment_interval_value'>, lastPaymentDate?: string): string {
 ...
 */
export function getDaysSinceLastPayment(loan: Pick<Loan, 'start_date'>, lastPaymentDate?: string): number {
...
export function calculateAccruedIncome(
  fixedIncome: Pick<FixedIncome, 'principal_amount' | 'income_rate' | 'payment_interval_unit' | 'payment_interval_value'>
): number {
 ...
 */
export function getNextIncomePaymentDate(fixedIncome: Pick<FixedIncome, 'start_date' | 'payment_interval_unit' | 'payment_interval_value'>, lastPaymentDate?: string): string {
 ...
 */
export function getDaysSinceLastIncomePayment(fixedIncome: Pick<FixedIncome, 'start_date'>, lastPaymentDate?: string): number {
...
export function applyPayment(
  loan: Pick<Loan, 'current_balance' | 'interest_rate' | 'loan_type' | 'repayment_interval_unit' | 'repayment_interval_value'>,
